...
public class Login extends javax.swing.JFrame {
 ...
 private void Identificar(String x, String y) {
    ...
    try { 
            ...
            util u = new util();
            cc.getConnection();
            //creamos un atributo para la consulta
            //String consul = "select * from usuarios  where usuario= '"+x+"' and  clave='ENCRYPTBYPASSPHRASE('password', '"+y+"') and estado ='S'";
            
            String consul = " select * from usuarios  where usuario='"+ x + "'  and CONVERT(VARCHAR(MAX), DECRYPTBYPASSPHRASE('clave', clave)) = '" + y + "'";
         //( SELECT \n" +
               // "CONVERT(VARCHAR(MAX), DECRYPTBYPASSPHRASE('clave', clave))\n" +
               // "FROM usuarios\n" +
                //"where usuario ='" + x ');";
            //ejecutando la consulta
            ResultSet rr=u.consultar(consul);
            //Instanciar la clase
            MDIApplication a = new MDIApplication();
            //validar
            if(rr.next())
            {
                ...
                this.hide();
                a.show();
                JOptionPane.showMessageDialog(null, "Bienvenid@ " + x);
